...
\begin{align}
	...
	\end{split}
\end{align}
\todo[inline]{Razmotrit koji omege u ovim dodanim clanovima su zeljene a koje obicne. Takodjer nemam mjerenu akceleraciju - koristim racunatu svugdje.}
...
\todo[inline]{Napisi jednadzbe dinamike pogreške}
\todo[inline]{Uvrsti upravljacki zakon unutra}
\todo[inline]{Pokazi da je problem stabilnosti jednak kao i prije}
