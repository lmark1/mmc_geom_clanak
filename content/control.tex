...
In order to express error dynamics, one needs to calculate time derivatives of linear \ref{linear_error} and angular \ref{angular_error} tracking errors:
\begin{gather}
