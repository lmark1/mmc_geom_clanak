...
\begin{gather}
	\dot{x} = v \\
	m_t\dot{v} - m_tge_3 - m_TR \vec{r}_{cm} \times \dot{\Omega} - m_tR\hat{\Omega}\hat{\vec{r}}_{cm}\Omega = -fRe_3 \\
	\dot{R} = R\hat{\Omega} \\
	J \dot{\Omega} + \Omega \times J \Omega + m_t \vec{r}_{cm} \times R^T \dot{v} = M
\end{gather}
...
Moment of inertia matrix is defined as follows:
\begin{equation}
