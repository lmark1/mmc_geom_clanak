...
\begin{figure}
	...
	\label{fig:uav_model}
\end{figure}
\noindent Equations \eqref{model2}, \eqref{model3} and \eqref{model4} describe the dynamical flow of a rotating and translating rigid body in terms of evolution of $(\text{R},\textbf{x},\mb{\Omega},\dot{\textbf{x}})\in \text{TSE}(3)$ on the tangent bundle of SE(3) \cite{LeeModel}. \todo{1.2. c)}
...
\begin{align}
	...
	\end{split}
\end{align}
where the following terms are defined as: \todo{1.1 c)}
\begin{itemize}
